...
class SlipperinessCondition extends Condition {
    private readonly type = 'origins:slipperiness';
...
export class SlipperinessConditionFactory {
    private readonly instance: SlipperinessCondition;

    constructor() {
        this.instance = new SlipperinessCondition();
    }
...
export default SlipperinessCondition;
