...
class HeightCondition extends Condition {
    private readonly type = 'origins:height';
...
export class HeightConditionFactory {
    private readonly instance: HeightCondition;

    constructor() {
        this.instance = new HeightCondition();
    }
...
export default HeightCondition;
