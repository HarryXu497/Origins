...
class HardnessCondition extends Condition {
    private readonly type = 'origins:hardness';
...
export class HardnessConditionFactory {
    private readonly instance: HardnessCondition;

    constructor() {
        this.instance = new HardnessCondition();
    }
...
export default HardnessCondition;
