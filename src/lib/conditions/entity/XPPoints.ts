...
class XPPointsCondition extends Condition {
...
export class XPPointsConditionFactory {
    private readonly instance: XPPointsCondition;

    constructor() {
        this.instance = new XPPointsCondition();
    }
...
export default XPPointsCondition;