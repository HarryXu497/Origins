...
export class SaturationLevelConditionFactory {
    private readonly instance: SaturationLevelCondition;

    constructor() {
        this.instance = new SaturationLevelCondition();
    }
...
export default SaturationLevelCondition;
