...
class XPLevelsCondition extends Condition {
    private readonly type = 'origins:xp_levels';
...
export class XPLevelsConditionFactory {
    private readonly instance: XPLevelsCondition;

    constructor() {
        this.instance = new XPLevelsCondition();
    }
...
export default XPLevelsCondition;